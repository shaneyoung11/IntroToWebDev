...
const integers2 = new Array(65, 93, 4, 71, 34, 82); //not the recommended way to create an array
...
// insert - arrays are mutable so you can change the information at certain indexes
integers[3] = 345;
...
// Concatenate array
val = integers.concat(instruments);

// sort
integers.sort();
console.log(integers); //won't work as expected in the console.

integers.sort((a, b) => a - b); //Best way to sort numbers in JS
